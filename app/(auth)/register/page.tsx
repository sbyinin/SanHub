    ...
    <div className="min-h-screen flex bg-black relative">
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            <h2 className="text-3xl font-light text-white">创建账号</h2>
            <p className="text-white/50 mt-2">注册开始你的 AI 创作之旅</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label className="text-sm text-white/50 uppercase tracking-wider">昵称</label>
              <input
                type="text"
                placeholder="您的昵称"
                value={name}
            ...
            <div className="space-y-2">
              <label className="text-sm text-white/50 uppercase tracking-wider">确认密码</label>
              <input
                type="password"
                placeholder="再次输入密码"
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 bg-gradient-to-bl from-white/5 to-transparent border-l border-white/10 relative z-10">
        ...
        <div className="space-y-6">
          <h1 className="text-5xl font-extralight text-white leading-tight">
            开启你的
            <br />
            <span className="font-normal">创作之旅</span>
          </h1>
          <p className="text-white/50 text-lg font-light max-w-md">
            注册即可获得免费积分，立即体验 AI 视频和图像生成的无限可能
          </p>
          <div className="flex items-center gap-3 p-4 bg-white/5 border border-white/10 rounded-xl w-fit backdrop-blur-sm">
            <Gift className="w-5 h-5 text-white/60" />
            <span className="text-white/80">新用户赠送 100 积分</span>
          </div>
        </div>
